...
/**
 * Conversion depuis un vecteur a 3 dimension é un vecteur a 2 dimension
 */
...
/**
 * Conversion depuis un vecteur a 2 dimension é un vecteur a 3 dimension
 */
...
/**
 * Conversion depuis un vecteur a 4 dimension é un vecteur a 2 dimension
 */
...
/**
 * Conversion depuis un vecteur a 2 dimension é un vecteur a 4 dimension
 */
...
/**
 * Conversion depuis un vecteur a 4 dimension é un vecteur a 3 dimension
 */
...
/**
 * Conversion depuis un vecteur a 3 dimension é un vecteur a 4 dimension
 */
...
/**
 * Test d'égaliter sur Vecteur a 2 dimension avec autre vecteur
 *  le parametre factor définie le degres de précision de l'operation
 */
...
/**
 * Test si le valeur flotante de est é zéro
 *  le parametre factor définie le degres de précision de l'operation
 */
...
/**
 * Test si une des valeurs du vecteur est é zéro
 *  le parametre factor définie le degres de précision de l'operation
 */
...
/**
 * Test si toute les valeurs du vecteur sont é zéro
 *  le parametre factor définie le degres de précision de l'operation
 */
...
/**
 * Renvois la premier puissance-deux aprés 'v'
 *
 * @param v
 * @return
 */
