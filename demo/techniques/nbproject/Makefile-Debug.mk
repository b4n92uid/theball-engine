...
LDLIBSOPTIONS=../../dist/Debug/MinGW-Windows/libtbe.a D:/librairies/c++/devil/DevIL-SDK-x86-1.7.8/lib/DevIL.lib D:/librairies/c++/freetype/freetype-2.3.9/objs/.libs/libfreetype.a D:/librairies/c++/glee/GLee5_4/GLee.lib D:/librairies/c++/sdl/SDL/SDL-1.2.14/lib/libSDLmain.a D:/librairies/c++/sdl/SDL/SDL-1.2.14/lib/libSDL.dll.a -lmingw32 -lopengl32 -lglu32

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk ../bin/techniques.exe

../bin/techniques.exe: ../../dist/Debug/MinGW-Windows/libtbe.a

../bin/techniques.exe: /D/librairies/c++/devil/DevIL-SDK-x86-1.7.8/lib/DevIL.lib

../bin/techniques.exe: /D/librairies/c++/freetype/freetype-2.3.9/objs/.libs/libfreetype.a

../bin/techniques.exe: /D/librairies/c++/glee/GLee5_4/GLee.lib

../bin/techniques.exe: /D/librairies/c++/sdl/SDL/SDL-1.2.14/lib/libSDLmain.a

../bin/techniques.exe: /D/librairies/c++/sdl/SDL/SDL-1.2.14/lib/libSDL.dll.a

../bin/techniques.exe: ${OBJECTFILES}
	${MKDIR} -p ../bin
	${LINK.cc} -o ../bin/techniques ${OBJECTFILES} ${LDLIBSOPTIONS} 
