...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk ../bin/skybox.exe

../bin/skybox.exe: ../../dist/Debug/MinGW-Windows/libtbe.a

../bin/skybox.exe: /D/librairies/c++/devil/DevIL-SDK-x86-1.7.8/lib/DevIL.lib

../bin/skybox.exe: /D/librairies/c++/freetype/freetype-2.3.9/objs/.libs/libfreetype.a

../bin/skybox.exe: /D/librairies/c++/glee/GLee5_4/GLee.lib

../bin/skybox.exe: /D/librairies/c++/sdl/SDL/SDL-1.2.14/lib/libSDLmain.a

../bin/skybox.exe: /D/librairies/c++/sdl/SDL/SDL-1.2.14/lib/libSDL.dll.a

../bin/skybox.exe: ${OBJECTFILES}
	${MKDIR} -p ../bin
	${LINK.cc} -o ../bin/skybox ${OBJECTFILES} ${LDLIBSOPTIONS} 
